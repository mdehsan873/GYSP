...
export default function EditBox({ open, setOpen, data, maxDays }) {
    ...
    const editDetailsBTN = async () => {
        ...
        // Min mark Check
        if (minMarks !== "") {
            if (minMarks > subjectMarks && subjectMarks !== "AB" && subjectMarks !== "-" && subjectMarks !== null && subjectMarks !== '') {
        ...
        // Max mark Check
        if (maxMarks !== "") {
            if (maxMarks < subjectMarks && subjectMarks !== "AB" && subjectMarks !== "-" && subjectMarks !== null && subjectMarks !== '') {
