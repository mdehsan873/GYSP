...
export const EventDetails2 = () => {
    ...
    return (
        <Box sx={{ width: "100%", marginBottom: "25px", pt: 6, }}>
            <Box marginTop={2}>
                <BackLink />
            </Box>
            <TableWrapper sx={{ width: '100%', boxShadow: "0px 3px 6px 0px rgba(0,0,0,0.2)", }}>
                <Stack direction={'row'} spacing={2} flexWrap={mob ? "wrap" : null} sx={{ justifyContent: mob ? null : "space-between", margin: mob ? "0" : "10px 55px 10px 20px", padding: mob ? "15px 15px 15px 15px" : null, gap: mob ? "10px" : "30px" }}>
                    <Stack spacing={2} m={2} mb={mob ? 0 : 0} style={{ margin: mob ? "0px 8px" : null, width: mob ? "100%" : "350px" }}>
                        <Typography variant='h5' style={{ textTransform: "capitalize", width: mob ? "100%" : "400px", textOverflow: "ellipsis", display: "block", overflow: "hidden" }}>{eventDetails[0]?.event_meta_data.event_name || "Event Name"}</Typography>
                        <Stack spacing={2} style={{ marginTop: "5px" }} m={0}>
                            <Typography style={{ marginTop: "0", fontSize: "16px", fontWeight: "500", textTransform: "capitalize", width: mob ? "100%" : "400px", textOverflow: "ellipsis", display: "block", overflow: "hidden" }} variant='body1'>{eventDetails[0]?.event_meta_data.description || "About"} </Typography>
                        </Stack>
                    </Stack>
                    <Stack spacing={2} m={2} style={{ margin: mob ? "0px 8px" : null }} justifyContent={"center"} textAlign={"left"}>
                    ...
                    <Stack spacing={2} m={2} justifyContent={"center"} style={{ margin: mob ? "0px 8px" : null }} textAlign={"left"}>
                    ...
                    <Stack spacing={2} mr={4} justifyContent={"center"} style={{ margin: mob ? "0px 8px" : null }} textAlign={"left"}>
                ...
                <Paper sx={{ width: '100%', boxShadow: "none", }} overflow={"hidden"}>
                    <Stack direction={mob ? 'column' : 'row'} gap={mob ? 1 : 10} spacing={2} mx={0} py={0}>
                        <Stack direction={'column'} style={{ width: mob ? "fit-content" : "45%" }} spacing={2} mx={mob ? 2 : 5} py={mob ? 1 : 3}>
                        ...
                        <Stack direction={'column'} style={{ width: mob ? "fit-content" : "45%", margin: mob ? "16px" : null, marginTop: mob ? "0" : null }} spacing={2} mx={mob ? 2 : 5} py={mob ? 1 : 3}>
                ...
                <Divider />
                <Paper sx={{ width: '100%', boxShadow: "none" }} overflow={"hidden"}>
                    <Stack direction={'row'} justifyContent={"space-between"} mt={2} mx={mob ? 2 : 5}>
                                        ...
                                        currentRows.map((row) => (
                                            ...
                                            >
                                                <TableCell align="left" component="th" style={{ padding: "8px", height: "61px" }} scope="row" sx={{ fontSize: "12px", fontWeight: "600", display: "flex", alignItems: "center", gap: "10px" }}>
                                                    {row?.profilePhoto == "" || row?.profilePhoto == undefined || row?.profilePhoto == null ? (<Image src={require('../../assets/Images/profile.png')} width={'35'} style={{ borderRadius: "50px" }} />) : (<Image src={"https://cyber-tutor-x-backend.vercel.app" + row?.profilePhoto} width={'35'} style={{ borderRadius: "50px" }} />)}
                                                    {row.firstName}
                                                </TableCell>
                                                <TableCell style={{ padding: "8px", height: "61px" }} align="center">{row.classAndSection}</TableCell>
                                                <TableCell style={{ padding: "8px", cursor: "pointer", height: "61px" }} align="center" >
                                                ...
                                                <TableCell style={{ padding: "8px", height: "61px" }} align="center">
                                                    {row.rank == 1 || row.rank == 2 || row.rank == 3 ? (
                                                        <React.Fragment>
                                                            {row.image1 == null ? (
                                                                <Image src={require('../../assets/Logo/noimage.png')} width={'45'} height={'35'} style={{ margin: "2px 5px", cursor: "pointer" }} />
                                                            ) : (
                                                                <>
                                                                    <Image src={"https://cyber-tutor-x-backend.vercel.app" + row.image1 || require("../../assets/Logo/noimage.png")} width={'45'} height={'35'} style={{ margin: "2px 5px", cursor: "pointer" }} />
                                                                </>
                                                            )}
                                                            {row.image2 == null ? (
                                                                <Image src={require('../../assets/Logo/noimage.png')} width={'45'} height={'35'} style={{ margin: "2px 5px", cursor: "pointer" }} />
                                                            ) : (
                                                                <Image src={"https://cyber-tutor-x-backend.vercel.app" + row.image2 || require("../../assets/Logo/noimage.png")} width={'45'} height={'35'} style={{ margin: "2px 5px", cursor: "pointer" }} />
                                                            )}
                                                            {eventDetails[0].event_meta_data.image == null ? (
                                                                <Image src={require('../../assets/Logo/noimage.png')} width={'45'} height={'35'} style={{ margin: "2px 5px", cursor: "pointer" }} />
                                                            ) : (
                                                                <Image src={"https://cyber-tutor-x-backend.vercel.app/" + eventDetails[0].event_meta_data.image || require("../../assets/Logo/noimage.png")} width={'45'} height={'35'} style={{ margin: "2px 5px", cursor: "pointer" }} />
                                                            )}
                                                        </React.Fragment>
                                                    ) : (eventDetails[0].event_meta_data.image == null ? (
                                                        <React.Fragment>
                                                            <Image src={require('../../assets/Logo/noimage.png')} width={'45'} height={'35'} style={{ margin: "2px 5px", cursor: "pointer", visibility: "hidden" }} />
                                                            <Image src={require('../../assets/Logo/noimage.png')} width={'45'} height={'35'} style={{ margin: "2px 5px", cursor: "pointer", visibility: "hidden" }} />
                                                            <Image src={require('../../assets/Logo/noimage.png')} width={'45'} height={'35'} style={{ margin: "2px 5px", cursor: "pointer" }} />
                                                        </React.Fragment>
                                                    ) : (
