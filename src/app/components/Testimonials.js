...
function Testimonials() {
  const testimonial =
    "The product helps you see how much work is needed to reach your goal.";
  return (
    <section className="container mt-36 text-center flex flex-col items-center">
      <h3 className="text-4xl font-bold">What Parent and Teacher Says</h3>
      ...
      <div className="mt-12 min-w-[80vw] justify-center md:gap-4 md:min-w-full grid gap-8 md:grid-cols-3">
        ...
        <TestimonialItem
          ...
          rating={3}
          testimonial="Product helps you see how many more days you need to work to reach your financial goal."
        />
        <TestimonialItem
          name="Amy Adams"
