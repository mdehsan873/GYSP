...
export const VerticalChart = ({ data, max, title, titleDisplay = true, stepStick = 10, barWidth = 20, chatHeight, chatWidth = "100%", boxShadowT = true, fontSiziize = 12 }) => {
    ...
    return (
        <Paper sx={{ p: 2, my: 0, height: '100%', pb: mob ? 1 : 2, boxShadow: boxShadowT ? (mob ? "0px 1px 3px 0px rgba(0,0,0,0.2)" : "0px 1px 6px 0px rgba(0,0,0,0.2)") : ('none'), borderRadius: mob ? "10px" : "15px", px: mob ? 0 : 2, pt: 1 }}>
            <div style={{
                width: '100%',
                // position: 'relative',
                // minHeight: '400px',
                ...
                <Typography style={{ textAlign: "center", color: "#3D3D3D", fontSize: "18px", fontWeight: "500", marginBottom: "16px", marginTop: "16px" }}>{title}</Typography>
                <Bar
